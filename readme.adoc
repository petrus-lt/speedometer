= HC-SR04 Speed Meter (Button-triggered, LCD I2C + Serial) :toc: :icons: font
...
== Usage
    ...
    Wire the components as described.
    Install required libraries.
    Upload the sketch to your Arduino.
    Open the Serial Monitor at 115200 baud.
    Press the button (connected to D2):
        LCD shows “Measuring…” during the process.
        Result is printed on Serial and shown on the LCD:
            Line 1: “X.XX m/s Y.Y km/h”
            Line 2: “Approaching” or “Moving away” (in the provided code: French strings “Rapproche” / “S’eloigne”)
...
== Interrupts vs. Polling
    ...
    By default, the sketch attempts to attach an external interrupt on D2 (Uno: INT0).
    If your board or pin doesn’t support interrupts, the provided variant can fall back to polling with software debounce.
    Keep ISR minimal (the sketch sets a flag in the ISR, then debounces and acts in loop()).
